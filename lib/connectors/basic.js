...
var BasicConnector = module.exports = function BasicConnector() {

};

util.inherits(BasicConnector, Connector);

BasicConnector.prototype.call = function(name, params, options, callback) {
